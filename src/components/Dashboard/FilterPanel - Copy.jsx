  ...
  return (
    <>
      ...
      <div style={filterGrid}>
        ...
        <MultiSelectDropdown label="Call / Put" options={OPTIONS.callPut} selected={filters.callPut} onChange={(v) => setFilter("callPut", v)} />
        ...
        <MultiSelectDropdown label="Underlying" options={OPTIONS.underlying} selected={filters.underlying} onChange={(v) => setFilter("underlying", v)} />
        <MultiSelectDropdown label="Expiry" options={OPTIONS.expiry} selected={filters.expiry} onChange={(v) => setFilter("expiry", v)} />
        <MultiSelectDropdown label="Strike" options={OPTIONS.strike} selected={filters.strike} onChange={(v) => setFilter("strike", v)} />
      </div>
    </>
  );
}
