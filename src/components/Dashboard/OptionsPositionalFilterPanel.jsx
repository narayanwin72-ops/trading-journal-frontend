...
/* =====================================================
   OPTIONS POSITIONAL – FILTER PANEL
===================================================== */

export default function OptionsPositionalFilterPanel({
  filters,
  setFilter,
  clearAllFilters,
  OPTIONS,
    ...
    <>
      ...
      <div style={filterGrid}>
        <MultiSelectDropdown
          ...
          selected={filters.underlying}
          onChange={(v) => setFilter("underlying", v)}
        />
        ...
        <MultiSelectDropdown
          ...
          onChange={(v) => setFilter("expiry", v)}
        />

        <MultiSelectDropdown
          label="Strike"
          options={OPTIONS.strike}
          selected={filters.strike}
          onChange={(v) => setFilter("strike", v)}
        />

        <MultiSelectDropdown
          label="Option Type"
          options={OPTIONS.optionType}
          selected={filters.optionType}
          onChange={(v) => setFilter("optionType", v)}
        />
        ...
        <MultiSelectDropdown
          label="Entry Reason"
          options={OPTIONS.entryReason}
          selected={filters.entryReason}
          onChange={(v) => setFilter("entryReason", v)}
        />
