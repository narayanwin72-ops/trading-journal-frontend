...
/* ================= MAIN ================= */
export default function SwingTradeLog() {
  ...
  /* ===== DATE FILTER (ENTRY DATE BASED) ===== */
  const filteredTrades = useMemo(() => {
    return swingTrades.filter((t) => {
      const tradeDate = t.entryDate || t.date || t.tradeDate;
  ...
  function downloadExcel() {
    ...
    link.download = "swing-trade-log.csv";
    link.click();
  }

  return (
    <div style={container}>
      <h3 style={{ marginBottom: "12px" }}>Swing Trading Trade Log</h3>
...
const HEADERS = [
  "Entry Date","Exit Date","Symbol","Position",
  "Entry","SL","Target","Qty",
...
const KEY_MAP = {
  "Entry Date": (t) => t.entryDate || t.date || t.tradeDate,
  "Exit Date": (t) => t.exitDate,
  "Symbol": (t) => t.stock || t.symbol,
  "Position": "position",
  "Entry": "entry",
  "SL": "sl",
  "Target": "target",
...
const remarksBox = { background:"#fff", padding:"20px", maxWidth:"600px", maxHeight:"80vh", overflowY:"auto", borderRadius:"12px" };
